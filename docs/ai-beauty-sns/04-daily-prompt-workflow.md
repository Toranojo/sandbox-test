...
【画像の向き】
・note掲載用のため、**全プロンプトを横向き（ランドスケープ）構図**にする。
　プロンプトの最後に "horizontal landscape orientation, 3:2 aspect ratio"
　のような一文を必ず入れる。
...
- [ ] "horizontal landscape orientation, 3:2 aspect ratio" 等、横向き指定が入っている（note掲載用）
