...
- 前回の有料投稿から3〜4日経っていれば、`characters/001-mio.md` の有料コンテンツカテゴリ一覧から、前回と別のカテゴリを選ぶ。
...
時間帯：{{時間帯}}
気分・行動：{{気分・行動}}
有料カテゴリ：{{characters/001-mio.mdの有料コンテンツカテゴリ①〜⑦から1つ選んで指定}}
...
`characters/001-mio.md`の「有料コンテンツの範囲」共通ルールに明記した
